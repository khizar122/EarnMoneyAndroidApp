...
public class PieView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        drawableCenterImage(canvas, drawableCenterImage);
    ...
    private void drawableCenterImage(Canvas canvas, Drawable drawable) {
    ...
    public void rotateTo(int index) {
        ...
        animate().setDuration(roundOfNumber * 500 + 900L)
